	...
	<div class="modal-dialog" role="document" style="max-width: 70%">
		<div class="modal-content" style="height: 90%">
			<div class="modal-header">
				<h5 class="modal-title" id="smallmodalLabel">Carta Escaneada: </h5>
                <button type="button" class="btn btn-primary" onClick="newSrc();" title="Mostrar archivo"> Mostrar documento </button>
