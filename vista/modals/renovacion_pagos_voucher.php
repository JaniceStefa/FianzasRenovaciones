<div  id="archivoC" style="display:none" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" onClick="originSrc();">
	<div class="modal-dialog" role="document" style="max-width: 70%">
		<div class="modal-content" style="height: 90%">
			<div class="modal-header">
				<h5 class="modal-title" id="smallmodalLabel">Detalles de Prima :</h5>      
                <button type="button" class="btn btn-primary" onClick="newSrc();" title="Mostrar archivo"> Mostrar Voucher </button>
